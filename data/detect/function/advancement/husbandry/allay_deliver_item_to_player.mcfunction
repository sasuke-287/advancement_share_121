...
execute unless data storage adv_share allay_deliver_item_to_player run tellraw @a {"text":"","color":"green","extra":[{"selector":"@s"},{"text":"が"},{"text":"allay_deliver_item_to_player","color":"gold"},{"text":"を解除しました"}]}
