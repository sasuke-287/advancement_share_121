...
execute unless data storage adv_share remove_wolf_armor run tellraw @a {"text":"","color":"green","extra":[{"selector":"@s"},{"text":"が"},{"text":"remove_wolf_armor","color":"gold"},{"text":"を解除しました"}]}
